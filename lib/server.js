...
exports.createIpcExecutor = (options) => {
    ...
    const listener = (event, id, request) => {
        const result = apollo_link_1.execute(options.link, Object.assign(Object.assign({}, request), { query: graphql_1.parse(request.query) }));
...
exports.IpcLink = client_1.IpcLink;
exports.createIpcLink = client_1.createIpcLink;
